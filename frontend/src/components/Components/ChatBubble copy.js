...
const ChatBubble = () => {
    ...
    const joinChat = () => setIsInChatRoom(true);
    ...
    return (
        <Card>
            <div className="customizer-setting d-none d-md-block">
                {isChatOpen ? (
                    <div className="max-w-[300px] fixed right-2 bottom-2 p-4 bg-white border border-gray-300 rounded-xl">
                        {!isInChatRoom ? (
                            // Name input area
                            <div id="chat_welcome">
                                <Input type="text" name="name" className="w-full mb-4 py-2 px-6 rounded-xl bg-gray-100" placeholder="Your name..." />
                                <Button color="danger" className="py-2 px-6 rounded-xl text-white" onClick={joinChat}>Join chat</Button>
                            </div>
                        ) : (
                            // Chat message area
