                    ...
                    <Row className="justify-content-center">
                        <Col lg={12}>
                            <div className="d-flex align-items-center mb-5">
                                ...
                                <Link to="/apps-laborApproach-explore" className="btn btn-primary">View All <i className="ri-arrow-right-line align-bottom"></i></Link>
                            </div>
                        </Col>
                    </Row>
                    <Row>
                                ...
                                <Card className="explore-box card-animate border">
                                    <CardBody>
                                        ...
                                        <div className="mt-3">
                                            ...
                                            <h6 className="fs-16 mb-0"><Link to="/apps-laborApproach-item-details">{item.category}</Link></h6>
                                        </div>
                                    </CardBody>
                                </Card>
                            </Col>
